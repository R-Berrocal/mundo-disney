...
router.post("/register", [
    (0, express_validator_1.check)("name", "name es required").not().isEmpty(),
    ...
    (0, express_validator_1.check)("password_", "password is required / must have more than 6 characters").isLength({ min: 6 }).not().isEmpty(),
